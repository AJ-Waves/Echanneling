...
<div class="container form-container">
    <div class="row">
        <div class="col-md-12 col-xs-12 title-div">
            <h4>Medical Checkup Appointment</h4>
        </div>
    </div>
    ...
    <form>
        <div class="row form-row-margin">
            <div class="col-md-2 col-xs-4">
                <label for="facname">Name of Facilitator:</label>
            </div>
            <div class="col-md-4 col-xs-8">
                <input type="text" class="form-control" id="facname">
            </div>
            <div class="col-md-2 col-xs-4">
                <label for="rtest">Requested Tests:</label>
            </div>
            <div class="col-md-4 col-xs-8">
                <input type="text" class="form-control" id="rtest">
            </div>
        </div>
        ...
        <div class="row form-row-margin" >
            ...
            <div class="col-md-4 col-xs-8">
                <input type="text" class="form-control" id="mcdate">
            </div>
            <div class="col-md-2 col-xs-4">
                <label for="mctime">Time:</label>
            </div>
            <div class="col-md-4 col-xs-8">
                <input type="text" class="form-control" id="mctime">
            </div>
        </div>

        <div class="row form-row-margin">
            <div class="col-md-2 col-xs-4">
                <label for="mcaddress">Address:</label>
            </div>
            <div class="col-md-4 col-xs-8">
                <textarea class="form-control" id="mcaddress" rows="3"></textarea>
            </div>
            <div class="col-md-2 col-xs-4">
    ...
    <form>
        <div class="row form-row-margin">
            <div class="col-md-2">
                <label for="cfee">Medical Tests' Fee (Rs.):</label>
            </div>
        </div>
        <div class="row form-row-margin">
            <div class="col-md-6">
        ...
        <div class="row form-row-margin">
            <div class="col-md-2">
                <label for="tcfee">Total Checkup Fee (Rs.):</label>
            </div>
            <div class="col-md-4">
                <input type="text" class="form-control" id="tcfee">
            </div>
        </div>
        <div class="row form-row-margin">
            <div class="col-md-2">
