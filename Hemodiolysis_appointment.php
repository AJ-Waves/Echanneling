...
<div class="container form-container">
    <div class="row">
        <div class="col-md-12 col-xs-12 title-div">
            <h4>Hemodialysis Appointment</h4>
        </div>
    </div>
    ...
    <form>
        <div class="row form-row-margin">
            <div class="col-md-2 col-xs-4">
                <label for="hename">Name of Facilitator:</label>
            </div>
            <div class="col-md-4 col-xs-8">
                <input type="text" class="form-control" id="hecname">
            </div>
            <div class="col-md-2 col-xs-4">
                <label for="hefacility">Facility:</label>
            </div>
            <div class="col-md-4 col-xs-8">
                <input type="text" class="form-control" id="hefacility">
            </div>
        </div>
        <div class="row form-row-margin" >
            <div class="col-md-2 col-xs-4">
                <label for="hedate">Date:</label>
            </div>
            <div class="col-md-4 col-xs-8">
                <input type="text" class="form-control" id="hedate">
            </div>
            <div class="col-md-2 col-xs-4">
                <label for="hetime">Time:</label>
            </div>
            <div class="col-md-4 col-xs-8">
                <input type="text" class="form-control" id="hetime">
            </div>
        </div>

        <div class="row form-row-margin">
            <div class="col-md-2 col-xs-4">
                <label for="headdress">Address:</label>
            </div>
            <div class="col-md-4 col-xs-8">
                <textarea class="form-control" id="headdress" rows="3"></textarea>
            </div>
            <div class="col-md-2 col-xs-4">
    ...
    <form>
        <div class="row form-row-margin">
            <div class="col-md-2">
                <label for="ffee">Facility Fee (Rs.):</label>
            </div>
            <div class="col-md-4">
                <input type="text" class="form-control" id="hefee">
            </div>
        </div>
        <div class="row form-row-margin">
            <div class="col-md-2">
